...
def working_process(generation_config):
    ...
    if "chat_history" not in st.session_state:
        ...
        AIMessage(content="Hey there! I'm a your PDF Assistant. Ask me anything about your PDFs")
    ]
...
def main():
    ...
    st.set_page_config(page_title="Chat with your PDFs", page_icon=":book:")
    st.header("Chat with your PDFs :book:")
